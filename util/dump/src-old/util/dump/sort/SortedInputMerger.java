...
class SortedInputMerger<E> implements DumpInput<E>, Iterator<E> {
   ...
   public boolean hasNext() {
      if ( nextPrepared ) return nextElement != null;
      ...
      try {
         ...
         case dualStream:
            ...
            int c = comparator == null ? ((Comparable)lastA).compareTo(lastB) : comparator.compare(lastA, lastB);
            if ( c > 0 ) {
               // return channel B

...
/**
 * The PrimitiveObjectStreamProvider uses very performant implementations for ObjectInput and ObjectOutput.<br><br>
 * 
 * The drawbacks are:<br>
 *  - only {@link Externalizable} instances may be used<br>
 *  - the {@link Externalizable}s may not use readObject() in readExternal() or writeObject(o) in writeExternal()<br><br>
 *  - if you put an instance twice into the dump, you will have two instances after deserialization in memory<br><br>
 * 
 * This IObjectStreamProvider can compress the streams using java.util.zip.Deflater. Use the appropriate constructor with values between 1 and 9.
 ...
 * @see FastObjectStreamProvider
 */
public class PrimitiveObjectStreamProvider<E extends Externalizable> implements ObjectStreamProvider {


   private final Class _class;
   private final int   _compression;

   public PrimitiveObjectStreamProvider( Class c ) {
      _class = c;
      _compression = 0;
   }
    ...
    */
   public PrimitiveObjectStreamProvider( Class c, int compression ) {
      _class = c;
   ...
   public ObjectInput createObjectInput( InputStream in ) throws IOException {
      ...
      return new PrimitiveObjectInputStream<E>(in, _class);
   }
   ...
   public ObjectOutput createObjectOutput( OutputStream out ) throws IOException {
      ...
      return new PrimitiveObjectOutputStream<E>(out, _class);
   }
}
